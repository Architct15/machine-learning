...
This is a classification problem and Random Forest (rf) method is usually the most accurate. I trained the model using cross validation with 3 folds. Then I further tested the out-of-sample accuracy using the testing set. Finallyl the accuracy is measured using a confusion matrix.
